...
public class TestBase {
	...
	public static Object[][] sauceBrowserDataProvider(Method testMethod) {
		return new Object[][] { 
				new Object[] { "chrome", "75", "macOS 10.14" },
	 ...
	 * @param version    Represents the version of the browser to be used as part of
	 *                   the test run.
	 * @param os         Represents the operating system to be used as part of the
	 *                   test run.
	 * @param methodName Represents the name of the test case that will be used to
	...
	/**
	 * Method that gets invoked after test. Dumps browser log and Closes the browser
	 */
	@AfterMethod
